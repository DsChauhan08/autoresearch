...
USE_VULKAN_SHADERC_RUNTIME="${USE_VULKAN_SHADERC_RUNTIME:-1}"
USE_VULKAN_WRAPPER="${USE_VULKAN_WRAPPER:-0}"
...
echo "[vulkan-build] Vulkan flags: USE_VULKAN=1 USE_VULKAN_SHADERC_RUNTIME=${USE_VULKAN_SHADERC_RUNTIME} USE_VULKAN_WRAPPER=${USE_VULKAN_WRAPPER}"
if [[ -n "${VULKAN_SDK:-}" ]]; then
  echo "[vulkan-build] VULKAN_SDK: ${VULKAN_SDK}"
fi
"${PYTHON_BIN}" --version
...
export USE_MPS=0
export USE_VULKAN=1
export USE_VULKAN_SHADERC_RUNTIME
export USE_VULKAN_WRAPPER
